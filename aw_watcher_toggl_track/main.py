...
def main():
    data = requests.get('https://api.track.toggl.com/api/v9/me/time_entries/current', headers={'content-type': 'application/json', 'Authorization' : 'Basic %s' %  b64encode(b"louis993546@gmail.com:HX28hBV*p39@U5LZsa&a$E9BL*kR^8y").decode("ascii")})
    print(data.json())
...
#
# logger = logging.getLogger("aw-watcher-toggl-track")
# DEFAULT_CONFIG = """
